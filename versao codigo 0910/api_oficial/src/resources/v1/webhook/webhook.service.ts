...
import {
  ...
  IWebhookTemplateStatusUpdateValue,
        ...
        for (const e of entry) {
          for (const change of e.changes) {
            if (change.field == 'message_template_status_update') {
              const value =
                change.value as unknown as IWebhookTemplateStatusUpdateValue;

              this.logger.log('Template status update recibido:', value);

              this.socket.updateTemplateStatus({
