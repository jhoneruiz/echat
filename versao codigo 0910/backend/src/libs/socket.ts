...
import { SyncTemplateStatus } from "../services/WhatsAppOficial/SyncTemplateStatus";
...
export const initIO = (httpServer: Server): SocketIO => {
  ...
  workspaces.on("connection", socket => {
    ...
    socket.on("updateTemplateStatusWhatsAppOficial", (data: any) => {
      SyncTemplateStatus(data).catch(err =>
        logger.error(`updateTemplateStatusWhatsAppOficial error: ${err.message}`)
      );
    });
