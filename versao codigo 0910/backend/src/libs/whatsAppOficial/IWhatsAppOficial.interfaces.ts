...
export type TTemplateCategory = 'MARKETING' | 'UTILITY' | 'AUTHENTICATION';
export type TTemplateComponentType = 'HEADER' | 'BODY' | 'FOOTER' | 'BUTTONS';
export type TTemplateHeaderFormat = 'TEXT' | 'IMAGE' | 'DOCUMENT' | 'VIDEO' | 'LOCATION';
export type TTemplateButtonType = 'QUICK_REPLY' | 'URL' | 'PHONE_NUMBER' | 'OTP' | 'COPY_CODE';

export interface ITemplateButtonOficial {
...
export interface ITemplateComponentExampleOficial {
    header_text?: string[];
    body_text?: string[][];
    header_handle?: string[];
}

export interface ITemplateComponentOficial {
    type: TTemplateComponentType;
    format?: TTemplateHeaderFormat;
    text?: string;
    buttons?: ITemplateButtonOficial[];
    example?: ITemplateComponentExampleOficial;
}

export interface ICreateTemplateOficial {
    name: string;
    language: string;
    category: TTemplateCategory;
    components: ITemplateComponentOficial[];
    allow_category_change?: boolean;
}

export interface IUpdateTemplateOficial {
    components: ITemplateComponentOficial[];
}

export interface ICreateTemplateOficialResponse {
    id: string;
    status: string;
    category: TTemplateCategory;
}

export interface IDeleteTemplateOficialResponse {
    success: boolean;
}