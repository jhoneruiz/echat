...
import SendMobileNotificationService from "../MobileNotification/SendMobileNotificationService";
...
const CreateMessageService = async ({
  ...
  SendMobileNotificationService(message).catch(err =>
    logger.error("[MobilePush] Failed to enqueue notification", err)
  );
