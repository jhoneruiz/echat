    ...
    translations: {
      ...
      userModal: {
        ...
        form: {
          ...
          allowSeeMessagesInPendingTickets: "Allow Viewing Pending Tickets",
          mobileNotifications: "Receive mobile notifications",
      ...
      notifications: {
        ...
        messageHidden: "Hidden message",
        newMessage: "New message from",
        mobile: {
          title: "Mobile push notifications",
          steps: {
            title: "Install on iPhone/iPad",
            subtitle: "Follow these steps to receive alerts even when the app is closed.",
            install: "1. Add the app to your home screen",
            installHint: "In Safari tap Share → Add to Home Screen.",
            open: "2. Open the installed icon",
            openHint: "Always use the shortcut to keep notifications active.",
            enable: "3. Tap “Enable notifications”",
            enableHint: "Grant permission and register the device."
          },
          status: {
            title: "Subscription status",
            subtitle: "Make sure the browser permission is enabled.",
            permission: "Browser permission: {{status}}",
            permissionHint: "If it shows as blocked, enable it in Settings > Safari.",
            permissionUnsupported: "This device does not support web push notifications.",
            subscriptions: "Registered devices: {{total}}"
          },
          actions: {
          ...
          activated: "Device registered successfully.",
          deactivated: "Subscription removed.",
          genericError: "We couldn't complete your request.",
      ...
      backendErrors: {
        ...
        ERR_META_24H_WINDOW:
          "Meta's 24-hour service window has expired. Send an approved template to resume the conversation.",
      },
