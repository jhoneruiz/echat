    ...
    translations: {
      ...
      userModal: {
        ...
        form: {
          ...
          mobileNotifications: "Receber notificações móveis",
      ...
      mainDrawer: {
        ...
        appBar: {
          user: {
            profile: "Perfil",
            mobileNotifications: "Notificações móveis",
            logout: "Sair",
            message: "Olá",
      ...
      notifications: {
        ...
        mobile: {
          ...
          steps: {
            ...
            subtitle: "Siga os passos para receber alertas mesmo com o app fechado.",
            install: "1. Adicione o aplicativo à tela inicial",
            installHint: "No Safari toque em Compartilhar → Adicionar à tela de início.",
            open: "2. Abra o ícone instalado",
            openHint: "Sempre utilize o atalho para manter as notificações ativas.",
            enable: "3. Toque em “Ativar notificações”",
            enableHint: "Autorize o permissão e registre o dispositivo."
          },
          status: {
            title: "Status da inscrição",
            subtitle: "Verifique se o navegador está autorizado a enviar alertas.",
            permission: "Permissão do navegador: {{status}}",
            permissionHint: "Se estiver bloqueado, habilite em Ajustes > Safari.",
            permissionUnsupported: "Este dispositivo não suporta notificações push.",
          ...
          activated: "Dispositivo registrado com sucesso.",
          deactivated: "Inscrição removida.",
      ...
      backendErrors: {
        ...
        ERR_META_24H_WINDOW:
          "A janela de 24 horas da Meta expirou. Envie um template aprovado para retomar a conversa.",
      },
