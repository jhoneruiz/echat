    ...
    translations: {
      ...
      userModal: {
        ...
        form: {
          ...
          allowSeeMessagesInPendingTickets: "السماح بمشاهدة المحادثات المعلقة",
          mobileNotifications: "استلام إشعارات الهاتف المحمول",
      ...
      notifications: {
        ...
        messageHidden: "رسالة مخفية",
        newMessage: "رسالة جديدة من",
        mobile: {
          title: "إشعارات الدفع على الهاتف",
          steps: {
            title: "التثبيت على iPhone / iPad",
            subtitle: "اتبع الخطوات لاستلام التنبيهات حتى عند إغلاق التطبيق.",
            install: "1. أضف التطبيق إلى الشاشة الرئيسية",
            installHint: "في سفاري اضغط مشاركة ← إضافة إلى الشاشة الرئيسية.",
            open: "2. افتح الأيقونة التي تم تثبيتها",
            openHint: "استخدم دائماً هذا الاختصار لتبقى الإشعارات مفعلة.",
            enable: "3. اضغط على \"تفعيل الإشعارات\"",
            enableHint: "اسمح بالإذن وقم بتسجيل الجهاز."
          },
          status: {
            title: "حالة الاشتراك",
            subtitle: "تأكد من أن متصفح سفاري يسمح بالإشعارات.",
            permission: "إذن المتصفح: {{status}}",
            permissionHint: "إذا كان محظوراً قم بتفعيله من الإعدادات > Safari.",
            permissionUnsupported: "هذا الجهاز لا يدعم إشعارات الويب.",
            subscriptions: "الأجهزة المسجلة: {{total}}"
          },
          actions: {
          ...
          activated: "تم تسجيل الجهاز بنجاح.",
          deactivated: "تم حذف الاشتراك.",
          genericError: "تعذر إكمال الطلب.",
          enabled: "الإشعارات مفعلة",
          disabled: "الإشعارات متوقفة",
          blocked: "الإذن محظور",
          unsupported: "الميزة غير مدعومة"
        }
      },
      triggerFlowModal: {
        title: "تفعيل التدفق",
