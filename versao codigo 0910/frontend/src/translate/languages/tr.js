    ...
    translations: {
      ...
      userModal: {
        ...
        form: {
          ...
          password: "Şifre",
          profile: "Profil",
          mobileNotifications: "Mobil bildirimleri al"
        },
        buttons: {
          okAdd: "Ekle",
          okEdit: "Kaydet",
      ...
      mainDrawer: {
        ...
        appBar: {
          user: {
            profile: "Profil",
            mobileNotifications: "Mobil bildirimler",
            logout: "Çıkış"
          }
        }
      },
      notifications: {
        ...
        messageHidden: "Gizli mesaj",
        newMessage: "Yeni mesaj",
        mobile: {
          title: "Mobil bildirimler",
          steps: {
            title: "iPhone/iPad kurulumu",
            subtitle: "Uygulama kapalıyken bile uyarı almak için aşağıdaki adımları izleyin.",
            install: "1. Uygulamayı ana ekrana ekleyin",
            installHint: "Safari'de Paylaş → Ana ekrana ekle seçeneğini kullanın.",
            open: "2. Yüklenen kısayolu açın",
            openHint: "Bildirimlerin gelmesi için her zaman bu simgeyi kullanın.",
            enable: "3. “Bildirimleri aç” düğmesine dokunun",
            enableHint: "İzin verin ve cihazı kaydedin."
          },
          status: {
            title: "Abonelik durumu",
            subtitle: "Tarayıcı izinlerinin açık olduğundan emin olun.",
            permission: "Tarayıcı izni: {{status}}",
            permissionHint: "Blokluysa Ayarlar > Safari bölümünden etkinleştirin.",
            permissionUnsupported: "Bu cihaz web push desteğine sahip değil.",
            subscriptions: "Kayıtlı cihaz sayısı: {{total}}"
          },
          actions: {
            activate: "Bildirimleri aç",
            deactivate: "Devre dışı bırak",
            refresh: "Durumu yenile"
          },
          activated: "Cihaz başarıyla kaydedildi.",
          deactivated: "Abonelik kaldırıldı.",
