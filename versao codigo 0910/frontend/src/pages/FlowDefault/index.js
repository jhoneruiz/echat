  ...
  const handleSaveDefault = async () => {
    ...
    if (configExist) {
      try {
        ...
        toast.success("Flujos predeterminados actualizados");
      } catch (err) {
        toastError(err);
      }
    } else {
        ...
        <Stack sx={{ padding: '12px', position: 'relative' }}>
          ...
          <Stack gap={'12px'}>
            ...
            <Typography fontSize={12}>
              Este flujo se ejecuta solo para nuevos contactos, personas que no tienes en tu lista y que enviaron un mensaje
            </Typography>
          ...
          <Stack gap={'12px'} marginTop={4}>
            ...
            <Typography fontSize={12}>
              La respuesta predeterminada se envía con cualquier carácter diferente de una palabra clave. ¡ATENCIÓN! Se disparará si la atención ya está cerrada y han pasado 6 horas desde su cierre.
            </Typography>
            {!loading && (<Autocomplete
              disablePortal
              id="combo-box-demo"
