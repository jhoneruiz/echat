            ...
            <Grid item xs={12} md={4}>
              <Card variant="outlined" className={classes.detailsCard}>
                <CardHeader
                  ...
                  subheader={campaign.whatsapp?.name || "No especificado"}
                />
              </Card>
            </Grid>
          )}
            ...
            <Grid item xs={12} md={4}>
              <Card variant="outlined" className={classes.detailsCard}>
                <CardHeader
                  ...
                  subheader={campaign.contactList?.name || "No especificado"}
                />
              </Card>
            </Grid>
          )}
          ...
          <Grid item xs={12} md={4}>
            <Card variant="outlined" className={classes.detailsCard}>
              <CardHeader
                ...
                subheader={datetimeToClient(campaign.scheduledAt) || "No agendado"}
              />
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Card variant="outlined" className={classes.detailsCard}>
              <CardHeader
                ...
                subheader={datetimeToClient(campaign.completedAt) || "No concluido"}
              />
            </Card>
          </Grid>
        </Grid>
