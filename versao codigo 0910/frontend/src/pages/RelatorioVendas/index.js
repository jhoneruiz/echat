    ...
    <div className={classes.root}>
      ...
      <Paper className={classes.filterSection}>
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs={12} sm={3}>
            <FormControl fullWidth>
              <InputLabel>Motivo de la no venta</InputLabel>
              <Select
          ...
          <Grid item xs={12} sm={3}>
            <FormControl fullWidth>
              <InputLabel>Motivo de la finalización</InputLabel>
              <Select
        ...
        <Grid item xs={12} sm={3}>
          <Card className={classes.statsCard}>
            <CardContent>
              ...
              <Typography className={classes.statsLabel}>No ventas</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={3}>
          ...
          <Table className={classes.table}>
            <TableHead>
              <TableRow>
                ...
                <TableCell>Motivo de la no venta</TableCell>
                <TableCell>Motivo de la finalización</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
        ...
        <Table className={classes.table}>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">No ventas</TableCell>
