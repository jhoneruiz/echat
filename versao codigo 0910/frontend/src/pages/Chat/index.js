...
export function ChatModal({
  ...
  const handleSave = async () => {
    try {
      ...
      console.error(err);
      toast.error("Error al crear/editar el chat");
    }
  };
    ...
    >
      <DialogTitle id="alert-dialog-title">
        {type === "edit"
          ...
          : i18n.t("chatIndex.modal.title") || "Crear grupo"}
      </DialogTitle>
      <DialogContent>
...
function Chat(props) {
  ...
  const handleEditMessage = (message) => {
    ...
    if (new Date() - new Date(message.createdAt) > 10 * 60 * 1000) {
      alert("Solo es posible editar mensajes enviados hace menos de 10 minutos.");
      return;
    }
        ...
        <Grid className={classes.gridItem} md={3} item>
          ...
          <ChatList
            ...
            handleSelectChat={(chat) =>
              selectChat(chat, "selección manual en la lista")
            }
          ...
          <Grid item xs={12}>
            ...
            >
              <Button
                ...
                style={{ minWidth: 120 }}
              >
                {i18n.t("chatIndex.createGroup") || "Crear grupo"}
              </Button>
            </div>
